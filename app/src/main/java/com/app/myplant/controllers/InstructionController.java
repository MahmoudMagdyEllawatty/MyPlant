...
public class InstructionController {
    private final String node = Config.INSTRUCTIONS_NODE;
    ArrayList<Instruction> users = new ArrayList<>();
    FirebaseHelper<Instruction> helper = new FirebaseHelper<Instruction>();

    public void Save(final Instruction user, final InstructionCallback callback){
    ...
    public void delete(Instruction trainingType, InstructionCallback callback){
    ...
    public void getInstructions(final InstructionCallback callback){
            ...
            public void onEvent(@Nullable QuerySnapshot queryDocumentSnapshots, @Nullable FirebaseFirestoreException e) {
                if(queryDocumentSnapshots == null && e != null){
                    ...
                    for (QueryDocumentSnapshot snap : queryDocumentSnapshots) {
                        Instruction user = snap.toObject(Instruction.class);
                        users.add(user);
                    }
                    callback.onSuccess(users);
                }
