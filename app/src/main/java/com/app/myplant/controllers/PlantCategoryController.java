...
public class PlantCategoryController {
    private final String node = Config.PLANT_CATEGORY_NODE;
    ArrayList<PlantCategory> users = new ArrayList<>();
    FirebaseHelper<PlantCategory> helper = new FirebaseHelper<PlantCategory>();

    public void Save(final PlantCategory user, final PlantCategoryCallback callback){
    ...
    public void delete(PlantCategory trainingType, PlantCategoryCallback callback){
    ...
    public void getPlantCategorys(final PlantCategoryCallback callback){
            ...
            public void onEvent(@Nullable QuerySnapshot queryDocumentSnapshots, @Nullable FirebaseFirestoreException e) {
                if(queryDocumentSnapshots == null && e != null){
                    ...
                    for (QueryDocumentSnapshot snap : queryDocumentSnapshots) {
                        PlantCategory user = snap.toObject(PlantCategory.class);
                        users.add(user);
                    }
                    callback.onSuccess(users);
                }
