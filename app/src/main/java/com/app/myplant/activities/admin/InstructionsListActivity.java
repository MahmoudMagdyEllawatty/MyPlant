...
import com.app.myplant.adapter.InstructionsAdapter;
import com.app.myplant.adapter.PlantAdapter;
import com.app.myplant.adapter.UserInstructionsAdapter;
...
public class InstructionsListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(R.string.instructions_list);
        ...
        add.setVisibility(SharedData.isUser ? View.GONE: View.VISIBLE);
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                SharedData.instruction = null;
                Intent intent = new Intent(InstructionsListActivity.this,AddInstuctionActivity.class);
    ...
    private void loadData(){
        new InstructionController().getInstructions(new InstructionCallback() {
            @Override
            public void onSuccess(ArrayList<Instruction> banks) {
                if(banks.isEmpty()){
                    ...
                    if(SharedData.isUser){
                        recyclerView.setAdapter(new UserInstructionsAdapter(banks, InstructionsListActivity.this));
                    }else{
                        recyclerView.setAdapter(new InstructionsAdapter(banks, InstructionsListActivity.this));
                    }
            ...
            public void onFail(String msg) {
                ...
                recyclerView.setVisibility(View.VISIBLE);
                imgNoProduct.setVisibility(View.GONE);
                Toast.makeText(InstructionsListActivity.this, msg, Toast.LENGTH_SHORT).show();
            }
        });
    }
