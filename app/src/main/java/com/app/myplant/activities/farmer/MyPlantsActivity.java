...
public class MyPlantsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(R.string.my_plants);
                ...
                .getFarmerPlants(new FarmerPlantCallback() {
                    ...
                    public void onSuccess(ArrayList<FarmerPlant> chats) {
                        ...
                        if(farmerPlants.isEmpty()){
                            ...
                            recyclerView.setAdapter(new MyPlantsAdapter(farmerPlants, MyPlantsActivity.this));
                        }
                    }
                    ...
                    public void onFail(String msg) {
                        ...
                        recyclerView.setVisibility(View.VISIBLE);
                        imgNoProduct.setVisibility(View.GONE);
                        Toast.makeText(MyPlantsActivity.this, msg, Toast.LENGTH_SHORT).show();
                    }
                });
