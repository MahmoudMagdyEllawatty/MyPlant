...
import com.app.myplant.activities.user.UserComplaintsActivity;
    ...
    private void loadData(){
        new ComplaintController().getComplaints(new ComplaintCallback() {
            ...
            public void onSuccess(ArrayList<Complaint> complaints) {
               ...
               banks = complaints;
                if(banks.isEmpty()){
                    ...
                    recyclerView.setAdapter(new ComplaintAdapter(banks, ComplaintListActivity.this));
                }
            }
            ...
            public void onFail(String msg) {
                ...
                recyclerView.setVisibility(View.VISIBLE);
                imgNoProduct.setVisibility(View.GONE);
                Toast.makeText(ComplaintListActivity.this, msg, Toast.LENGTH_SHORT).show();
            }
        });
    }
